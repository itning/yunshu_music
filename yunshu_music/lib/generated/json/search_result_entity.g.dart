...
SearchResultEntity $SearchResultEntityFromJson(Map<String, dynamic> json) {
	...
	final List<SearchResultData>? data = jsonConvert.convertListNotNull<SearchResultData>(json['data']);
	if (data != null) {
...
SearchResultData $SearchResultDataFromJson(Map<String, dynamic> json) {
	...
	final List<String>? highlightFields = jsonConvert.convertListNotNull<String>(json['highlightFields']);
