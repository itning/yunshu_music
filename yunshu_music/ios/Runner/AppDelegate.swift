...
@objc class AppDelegate: FlutterAppDelegate {
    ...
    override func application(
        ...
        methodChannel = FlutterMethodChannel(name: "yunshu.music/method_channel", binaryMessenger: controller.binaryMessenger)
        methodChannel!.setMethodCallHandler(handlerCall)
        let playbackStateEventChannel = FlutterEventChannel(name: "yunshu.music/playback_state_event_channel", binaryMessenger: controller.binaryMessenger)
        let metadataEventChannel = FlutterEventChannel(name: "yunshu.music/metadata_event_channel", binaryMessenger: controller.binaryMessenger)
